...
function verificarChute(e) {
    if (e.key === 'Enter') {
        realizarChute();
    }
}

document.querySelector('input').addEventListener('keyup', verificarChute);
document.getElementById('chute').addEventListener('click', realizarChute);
